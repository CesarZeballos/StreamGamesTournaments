...
export const tournaments = [
	{
		...
		awards: ['$500', '$400', '$200'],
		description:
			'Join the battle in this exciting team strategy game, where skills and tactics determine victory in epic 5v5 combat, requiring precise coordination, sharp reflexes, and a deep understanding of team dynamics for success.',
		urlAvatar:
			'https://res.cloudinary.com/dofwlsemg/image/upload/v1722951332/csgo_mumbrh.jpg',
		membersNumber: 5,
		maxTeams: 4,
		price: 5000,
	...
	},
	{
		...
		awards: ['$900', '$700', '$600'],
		description:
			'Jump into the action in this vibrant battle royale, build structures, outmaneuver your opponents and be the last one standing in an ever-changing world, filled with unpredictable challenges and ever-evolving gameplay experiences.',
		urlAvatar:
			'https://res.cloudinary.com/dofwlsemg/image/upload/v1722951339/fortnite_se4taz.jpg',
		membersNumber: 5,
		maxTeams: 4,
		price: 1500,
		organizerId: 'b1c9e5d4-5f94-41b3-9e40-4d42b6a4b382',
		gameId: 'f4b9a5d2-0a9c-4c89-96b1-3d0e7f6a1e8b',
		teams: ['a1b2c3d4-5678-90ab-cdef-1234567890ab'],
	},
	{
		id: 'uuid-3',
		...
		description:
			'Master the Rift in this fast-paced strategy game, where champions clash in a fight for supremacy, demanding keen strategy, flawless execution, and a deep knowledge of the game’s diverse characters and mechanics.',
		urlAvatar:
			'https://res.cloudinary.com/dofwlsemg/image/upload/v1722951355/lol_dfz0bt.png',
		membersNumber: 5,
		maxTeams: 4,
		price: 550,
		organizerId: 'b1c9e5d4-5f94-41b3-9e40-4d42b6a4b382',
